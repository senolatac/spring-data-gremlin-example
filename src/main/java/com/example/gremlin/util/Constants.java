...
public class Constants {
    ...
    public static final String GREMLIN_PRIMITIVE_VALUE_MAP = "valueMap().with(WithOptions.tokens)";
    public static final String GREMLIN_PRIMITIVE_ELEMENT_MAP = "elementMap()";
